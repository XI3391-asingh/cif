...
CREATE SEQUENCE IF NOT EXISTS country_master_id_seq;
--- Table Name : country
...
CREATE SEQUENCE IF NOT EXISTS lookup_master_id_seq;
...
CREATE UNIQUE INDEX idex_lookup_master
ON lookup_master(type, code, is_active);

CREATE UNIQUE INDEX idex_addess_master  
ON address_master(type, code, is_active);

CREATE UNIQUE INDEX idex_country_master
ON country_master(code, isd_code, iso_code, is_active);