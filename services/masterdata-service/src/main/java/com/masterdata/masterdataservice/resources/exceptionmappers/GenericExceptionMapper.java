...
import com.masterdata.masterdataservice.api.ErrorResponseApi;
import com.masterdata.masterdataservice.resources.exceptions.DatabasePersistException;
import com.masterdata.masterdataservice.resources.exceptions.DuplicateRecordException;
import com.masterdata.masterdataservice.resources.exceptions.InvalidParameterException;
import com.masterdata.masterdataservice.resources.exceptions.ServerSideException;
...
import static com.masterdata.masterdataservice.core.masterdata.helper.ResponseHelper.buildResponseForErrors;
...
public class GenericExceptionMapper implements ExceptionMapper<RuntimeException> {
    ...
    public Response toResponse(RuntimeException exception) {
        ...
        if (exception instanceof ServerSideException serverSideException) {
            LOGGER.error("Server Side Exception caught: {}", serverSideException.getMessage());
            ...
            LOGGER.error("Database Persist Exception: {}", databasePersistException.getMessage());
